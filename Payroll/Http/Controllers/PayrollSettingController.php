...
class PayrollSettingController extends AccountBaseController
{
    ...
    public function MonthDayUpdate(Request $request)
    {
        $monthDays = $request->input('month_days');

        foreach ($monthDays as $data) {
            MonthDay::where('month', $data['month'])->update([
    ...
    public function index()
    {
        ...
        $this->expensetypes = ExpenseType::where('company_id', user()->company_id)->get();
        ...
        switch ($tab) {
            ...
            case 'months-days':
                ...
                $this->monthDays = MonthDay::get();
                $this->view = 'payroll::payroll-setting.ajax.month-days';
                break;
            ...
            case 'payroll-currency-setting':
                ...
                break;
                case 'expense-type':
                    $this->view = 'payroll::payroll-setting.ajax.expense-type';
                    break;
