...
use Modules\Payroll\DataTables\SalaryAttentenceLeaveCalculationDataTable;
...
class SalaryAttentenceLeaveCalculationController extends AccountBaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->pageTitle = 'app.menu.SalaryAttentenceLeaveCalculation';
     ...
     * @return Response
     */
    public function index(SalaryAttentenceLeaveCalculationDataTable $dataTable)
    {
        ...
        return $dataTable->render('payroll::salary-attentence-leave-calculation.index', $this->data);
    }
    /**
    ...
    public function create()
    {
        ...
        return view('payroll::salary-attentence-leave-calculation.ajax.create', $this->data);
