        ...
        <x-form id="edit-repayment-form" method="PUT" enctype="multipart/form-data">
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    @lang('app.editSalaryAdvanceRepayment')
                </h4>
                ...
                <div class="row px-4">
                    ...
                    <div class="col-lg-3 col-md-6 mt-2">
                        @if ($repayment->files->isNotEmpty())
                            <img src="{{ $repayment->files->first()->file_url }}" alt="Repayment Proof" width="200">
                        @else
...
<script>
    ...
    $('#update-repayment').click(function(e) {
        ...
        const url = "{{ route('salary-advance.repayment.update', $repayment->id) }}";
        $.easyAjax({
            url: url,
