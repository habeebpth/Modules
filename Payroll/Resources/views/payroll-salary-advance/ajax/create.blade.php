    ...
    <div class="col-sm-12">
        <x-form id="save-payroll-advance-form">
            <div class="add-client bg-white rounded">
                ...
                <div class="row px-4">
                    <div class="col-md-6">
                        <x-forms.select fieldId="advance_type" :fieldLabel="__('app.advanceType')" fieldName="advance_type" fieldRequired="true">
                ...
                <div class="row px-4">
                    <div class="col-md-6">
                        <x-forms.datepicker fieldId="request_date" :fieldLabel="__('app.requestDate')" fieldName="request_date" :fieldPlaceholder="__('placeholders.date')" :fieldValue="now(company()->timezone)->translatedFormat(company()->date_format)" />
                    </div>
                ...
                <div class="row px-4">
                    <div class="col-md-12">
                        <x-forms.textarea fieldId="reason" :fieldLabel="__('app.reason')" fieldName="reason" :fieldPlaceholder="__('placeholders.reason')" />
                    </div>
                </div>
                ...
                <div class="row px-4" id="installment-section" style="display: none;">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="my-3 form-group">
                            ...
                            <div class="d-flex">
                                <x-forms.checkbox fieldLabel="" fieldName="deduct_from_salary" fieldId="deduct_from_salary" />
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ['#request_date', '#approval_date', '#disbursement_date'].forEach(function(id) {
        ...
        $('#save-payroll-advance').click(function() {
            const url = "{{ route('salary-advance.store') }}";
