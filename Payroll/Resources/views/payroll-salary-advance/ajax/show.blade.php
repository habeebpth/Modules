<div id="salary-advance-section">
    <h3 class="heading-h1 mb-3">{{ $salaryadvance->employeeuser->name }}</h3>
    <div class="row">
        <div class="col-sm-12">
            <div class="card bg-white border-0 b-shadow-4">
                <div class="card-body">
                    <div class="col-12 px-0 pb-3 d-block d-lg-flex d-md-flex">
                        <p class="mb-0 text-lightest f-14 w-30 d-inline-block text-capitalize">Advance Type</p>
                        <p class="mb-0 text-dark-grey f-14 w-70">{{ $salaryadvance->advance_type ?? '--' }}</p>
                    </div>

                    <div class="col-12 px-0 pb-3 d-block d-lg-flex d-md-flex">
                        <p class="mb-0 text-lightest f-14 w-30 d-inline-block text-capitalize">Employee</p>
                        <p class="mb-0 text-dark-grey f-14 w-70">{{ $salaryadvance->employeeuser->name ?? '--' }}</p>
                    </div>

                    <div class="col-12 px-0 pb-3 d-block d-lg-flex d-md-flex">
                        <p class="mb-0 text-lightest f-14 w-30 d-inline-block text-capitalize">Request Date</p>
                        <p class="mb-0 text-dark-grey f-14 w-70">{{ $salaryadvance->request_date ?? '--' }}</p>
                    </div>

                    <div class="col-12 px-0 pb-3 d-block d-lg-flex d-md-flex">
                        <p class="mb-0 text-lightest f-14 w-30 d-inline-block text-capitalize">Amount</p>
                        <p class="mb-0 text-dark-grey f-14 w-70">{{ $salaryadvance->amount ?? '--' }}</p>
                    </div>
                </div>
            </div>

            <!-- salaryadvance TABS START -->
                                        ...
                                        <tr class="row{{ $repayment->id }}">
                                            ...
                                            <td class="text-right">
                                                <div class="task_view mt-1 mt-lg-0 mt-md-0">
                                                    <a href="{{ route('salary-advance.repayment.edit', $repayment->id) }}"
