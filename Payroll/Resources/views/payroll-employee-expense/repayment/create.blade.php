        ...
        <x-form id="save-repayment-form">
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    @lang('app.addEmployeeExpenseRepayment')
                </h4>

                <input type="hidden" name="company_id" value="{{ $company_id }}">
                <input type="hidden" name="employee_expense_id" value="{{ $employee_expense_id }}">
                <div class="row px-4">
                    <div class="col-md-6">
...
<script>
    $(document).ready(function() {
        ...
        $('#save-repayment').click(function(e) {
            ...
            const url = "{{ route('employee-expense.repayment.store') }}";
