...
class DwcHotelsDataTable extends BaseDataTable
{
     ...
     */
    public function query(DwcHotel $model)
    {
    ...
    {
        $dataTable = $this->setBuilder('dwc-hotel-table', 2)
            ->parameters([
                'initComplete' => 'function () {
                    window.LaravelDataTables["dwc-hotel-table"].buttons().container()
    ...
    protected function getColumns()
    {
        ...
        $data = [
            ...
            __('app.location') => ['data' => 'location', 'name' => 'location', 'exportable' => false, 'title' => __('app.location')],
            __('app.totalRooms') => ['data' => 'total_rooms', 'name' => 'total_rooms', 'exportable' => false, 'title' => __('app.totalRooms')],
            __('modules.guests.mobile') => ['data' => 'contact_number', 'name' => 'contact_number', 'exportable' => false, 'title' => __('modules.guests.mobile')],
