...
class DwcHorseDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        $datatables = datatables()->eloquent($query)
            ...
            ->addColumn('action', function ($row) {
                ...
                $action .= '<a href="' . route('horses.show', [$row->id]) . '" class="dropdown-item"><i class="fa fa-eye mr-2"></i>' . __('app.view') . '</a>';
                $action .= '<a class="dropdown-item openRightModal" href="' . route('horses.edit', [$row->id]) . '">
     ...
     */
    public function query(DwcHorse $model)
    {
    ...
    {
        $dataTable = $this->setBuilder('dwc-horse-table', 2)
            ->parameters([
                'initComplete' => 'function () {
                    window.LaravelDataTables["dwc-horse-table"].buttons().container()
    ...
    protected function getColumns()
    {
        ...
        $data = [
            ...
            __('app.country') => ['data' => 'country', 'name' => 'country', 'exportable' => false, 'title' => __('app.country')],
            __('app.age') => ['data' => 'age', 'name' => 'age', 'exportable' => false, 'title' => __('app.age')],
            __('app.color') => ['data' => 'color', 'name' => 'color', 'exportable' => false, 'title' => __('app.color')],
            __('app.gender') => ['data' => 'gender', 'name' => 'gender', 'exportable' => false, 'title' => __('app.gender')],
        ];
