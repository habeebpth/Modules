...
class DwcBillingCodeDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        $datatables = datatables()->eloquent($query)
            ...
            ->addColumn('action', function ($row) {
                ...
                // $action .= '<a href="' . route('billing-code.show', [$row->id]) . '" class="dropdown-item"><i class="fa fa-eye mr-2"></i>' . __('app.view') . '</a>';
                $action .= '<a class="dropdown-item openRightModal" href="' . route('billing-code.edit', [$row->id]) . '">
     ...
     */
    public function query(DwcBillingCode $model)
    {
    ...
    {
        $dataTable = $this->setBuilder('dwc-billing-code-table', 2)
            ->parameters([
                'initComplete' => 'function () {
                    window.LaravelDataTables["dwc-billing-code-table"].buttons().container()
