    ...
    <div class="d-flex d-lg-block filter-box project-header bg-white">
        ...
        <div class="project-menu" id="mob-client-detail">
            ...
            <nav class="tabs">
                <ul class="-primary">
                    <li>
                        <x-tab :href="route('horses.show', $horses->id)" :text="__('modules.projects.overview')" class="overview" />
                    </li>
                        {{-- <li>
                            <x-tab :href="route('horses.show', $horses->id).'?tab=roomtype'" :text="__('app.roomtype')"
                            class="roomtype" />
                        </li> --}}
                </ul>
            </nav>
