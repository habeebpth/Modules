...
@section('filter-section')
    <x-filters.filter-box>
        ...
        {{-- <div class="select-box d-flex pr-2 border-right-grey border-right-grey-sm-0" style="max-width: 300px;">
            <p class="mb-0 pr-2 f-14 text-dark-grey d-flex align-items-center">@lang('app.Time')</p>
            <div class="select-status d-flex">
                <input type="text" id="timeRangeStart" class="position-relative text-dark form-control border-0 p-1 text-left f-14 f-w-500 border-additional-grey"
                    placeholder="@lang('placeholders.startTime')" style="width: 100px;">
                <input type="text" id="timeRangeEnd" class="position-relative text-dark form-control border-0 p-1 text-left f-14 f-w-500 border-additional-grey"
                    placeholder="@lang('placeholders.endTime')" style="width: 100px;">
            </div>
        </div> --}}
        <div class="select-box d-flex pr-2 border-right-grey border-right-grey-sm-0" style="max-width: 300px;">
            <div class="select-status d-flex">
...
@push('scripts')
    ...
    <script>
        ...
        $('#dwc-arrival-table').on('preXhr.dt', function(e, settings, data) {
        ...
        const showTable = () => {
            window.LaravelDataTables["dwc-arrival-table"].draw(true);
        }
        $(' #airport_id')
            .on('change keyup',
                function() {
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('dwc.arrivals.destroy', ':id') }}";
