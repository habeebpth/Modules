...
@section('filter-section')
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            <div class="select-status">
                <select class="form-control select-picker" name="checkinout" id="checkinout" data-live-search="true" data-size="8">
                    <option value="checkin_date">@lang('app.checkinReport')</option>
                    <option value="checkout_date">@lang('app.checkoutReport')</option>
                </select>
            </div>
        </div>
...
<script>
    ...
    $('#hotel-reservation-table').on('preXhr.dt', function(e, settings, data) {
    ...
    const showTable = () => {
        window.LaravelDataTables["hotel-reservation-table"].draw(true);
    }
    $(' #checkinout')
        .on('change keyup',
            function() {
