    ...
    <div class="d-flex d-lg-block filter-box project-header bg-white">
        ...
        <div class="project-menu" id="mob-client-detail">
            ...
            <nav class="tabs">
                <ul class="-primary">
                    <li>
                        <x-tab :href="route('hotels.show', $hotels->id)" :text="__('modules.projects.overview')" class="overview" />
                    </li>
                        <li>
                            <x-tab :href="route('hotels.show', $hotels->id).'?tab=roomtype'" :text="__('app.roomtype')"
                            class="roomtype" />
                        </li>
                </ul>
            </nav>
...
@push('scripts')
    ...
    <script>
        ...
        $('body').on('click', '.edit-roomType', function () {
                ...
                var url = "{{ route('hotel.roomtype.edit', ':id') }}";
