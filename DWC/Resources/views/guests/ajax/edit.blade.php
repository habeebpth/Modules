...
<div class="row">
    <div class="col-sm-12">
        <x-form id="save-guest-data-form" method="PUT">
            ...
            <div class="bg-white rounded add-client">
                ...
                <div class="p-20 row">
                        ...
                        <x-forms.select fieldId="horse" :fieldLabel="__('modules.guests.horse')" fieldName="horse" search="true"
                            ...
                            @foreach ($horses as $horse)
                                <option value="{{ $horse->id }}"
                                    {{ $dwcguest->horse_id == $horse->id ? 'selected' : '' }}>{{ $horse->name }}
                                </option>
                            @endforeach
                        </x-forms.select>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <x-forms.select fieldId="guest_type" :fieldLabel="__('modules.guests.guest_type')" fieldName="guest_type" search="true"
                            ...
                            @foreach ($guesttypes as $guesttype)
                                <option value="{{ $guesttype->id }}"
                                    {{ $dwcguest->guest_type == $guesttype->id ? 'selected' : '' }}>{{ $guesttype->name }}
                                </option>
                            @endforeach
                        </x-forms.select>
                    </div>
                        ...
                        <x-forms.select fieldId="salutation" fieldName="salutation" :fieldLabel="__('modules.client.salutation')">
                            ...
                            @foreach ($salutations as $salutation)
                                <option value="{{ $salutation->value }}"
                                    {{ $dwcguest->salutation == $salutation->value ? 'selected' : '' }}>
                    ...
                    <div class="col-lg-3 col-md-3">
                        <x-forms.text fieldId="first_name" :fieldLabel="__('modules.guests.guestFirstName')" fieldName="first_name" fieldRequired="true"
                            :fieldValue="$dwcguest->first_name" :fieldPlaceholder="__('placeholders.name')">
                        </x-forms.text>
                    </div>
                    <div class="col-lg-3 col-md-3">
                        <x-forms.text fieldId="last_name" :fieldLabel="__('modules.guests.guestLastName')" fieldName="last_name" :fieldValue="$dwcguest->last_name"
                    ...
                    <div class="col-lg-4 col-md-4">
                        <x-forms.text fieldId="company" :fieldLabel="__('modules.guests.company')" fieldName="company" :fieldPlaceholder="__('placeholders.company')"
                            :fieldValue="$dwcguest->company ?? ''">
                        </x-forms.text>
                    </div>
                    <div class="col-md-3">
                        <div class="my-3 form-group">
                            <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.address')" fieldName="address"
                                fieldId="address" :fieldPlaceholder="__('placeholders.address')" fieldRequired="true" :fieldValue="$dwcguest->address_1">
                            </x-forms.textarea>
                        </div>
                    </div>
                        ...
                        <x-forms.select fieldId="country" :fieldLabel="__('app.country')" fieldName="country" search="true">
                            ...
                            @foreach ($countries as $item)
                                <option data-tokens="{{ $item->iso3 }}" data-phonecode="{{ $item->phonecode }}"
                                    ...
                                    value="{{ $item->id }}"
                                    {{ ($dwcguest->country ?? '') == $item->id ? 'selected' : '' }}>
                                    {{ $item->nicename }}
                                </option>
                            @endforeach
                        </x-forms.select>
                            ...
                            <x-forms.select fieldId="country_phonecode" fieldName="country_phonecode" search="true">
                                ...
                                @foreach ($countries as $item)
                                    <option data-tokens="{{ $item->name }}" data-country-iso="{{ $item->iso }}"
                                        ...
                                        {{ ($dwcguest->mobile_county_code ?? '') == $item->phonecode ? 'selected' : '' }}>
                                        {{ $item->phonecode }}
                                    </option>
                                @endforeach
                            </x-forms.select>
                        ...
                        <x-forms.select fieldId="nationality" :fieldLabel="__('app.nationality')" fieldName="nationality"
                            ...
                            @foreach ($countries as $item)
                                <option data-tokens="{{ $item->iso3 }}" data-phonecode="{{ $item->phonecode }}"
                                    ...
                                    data-content="<span class='flag-icon flag-icon-{{ strtolower($item->iso) }} flag-icon-squared'></span> {{ $item->nicename }}"
                                    value="{{ $item->id }}"
                                    {{ ($dwcguest->nationality ?? '') == $item->id ? 'selected' : '' }}>
                                    {{ $item->nicename }}
                                </option>
                            @endforeach
                        </x-forms.select>
                    ...
                    <div class="col-md-3">
                        <div class="form-group my-3">
                            <label class="f-14 text-dark-grey mb-12 w-100" for="usr">@lang('modules.guests.visa_required')</label>
                            <div class="d-flex">
                                <x-forms.radio fieldId="login-yes" :fieldLabel="__('app.yes')" fieldName="visa_required"
                                    fieldValue="1" :checked="$dwcguest->visa_required == '1' ? 'checked' : ''">
                                </x-forms.radio>
                                <x-forms.radio fieldId="login-no" :fieldLabel="__('app.no')" fieldValue="0"
                                    fieldName="visa_required" :checked="$dwcguest->visa_required == '0' ? 'checked' : ''">
                                </x-forms.radio>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text fieldId="passport_number" :fieldLabel="__('modules.guests.passport_number')" fieldName="passport_number"
                            :fieldValue="$dwcguest->passport_number" :fieldPlaceholder="__('placeholders.zip')">
                        </x-forms.text>
                    </div>
                </div>
                <hr>
                ...
                <div class="container-fluid">
                    <div id="flightItemsContainer">
                        @if ($dwcguest->flightTickets->count() > 0)
                            @foreach ($dwcguest->flightTickets as $index => $flightTicket)
                                <div class="flight-item card">
                                    <div class="flight-header">
                                        <h5 class="mb-0">Flight Ticket #{{ $index + 1 }}</h5>
                                        <span class="remove-flight"><i class="fas fa-times-circle"></i></span>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="f-14 text-dark-grey">Flight Number <sup
                                                        class="f-14 mr-1">*</sup></label>
                                                <input type="text" class="form-control height-35 f-14"
                                                    name="flight_no[]" value="{{ $flightTicket->flight_no }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="f-14 text-dark-grey">Departure Date <sup
                                                        class="f-14 mr-1">*</sup></label>
                                                <input type="date" class="form-control height-35 f-14"
                                                    name="departure_date[]"
                                                    value="{{ $flightTicket->departure_date }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="f-14 text-dark-grey">Departure Time <sup
                                                        class="f-14 mr-1">*</sup></label>
                                                <input type="time" class="form-control height-35 f-14"
                                                    name="departure_time[]"
                                                    value="{{ $flightTicket->departure_time }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="f-14 text-dark-grey">Arrival Date <sup
                                                        class="f-14 mr-1">*</sup></label>
                                                <input type="date" class="form-control height-35 f-14"
                                                    name="arrival_date[]" value="{{ $flightTicket->arrival_date }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="f-14 text-dark-grey">Arrival Time <sup
                                                        class="f-14 mr-1">*</sup></label>
                                                <input type="time" class="form-control height-35 f-14"
                                                    name="arrival_time[]" value="{{ $flightTicket->arrival_time }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-2 flight_from">
                                            <x-forms.select2-ajax fieldId="flight_from" fieldName="flight_from[]"
                                                route="{{ route('guests.airports') }}" fieldLabel="From"
                                                search="true" selected="{{ $flightTicket->flight_from }}">
                                            </x-forms.select2-ajax>
                                        </div>
                                        <div class="col-md-2 flight_to">
                                            <x-forms.select2-ajax fieldId="flight_to" fieldName="flight_to[]"
                                                route="{{ route('guests.airports') }}" fieldLabel="To"
                                                search="true" selected="{{ $flightTicket->flight_to }}">
                                            </x-forms.select2-ajax>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="f-14 text-dark-grey">Class</label>
                                                <select class="form-select form-control height-35 f-14"
                                                    name="flight_class[]">
                                                    <option value>---</option>
                                                    <option value="First Class"
                                                        {{ $flightTicket->flight_class == 'First Class' ? 'selected' : '' }}>
                                                        First Class</option>
                                                    <option value="Business Class"
                                                        {{ $flightTicket->flight_class == 'Business Class' ? 'selected' : '' }}>
                                                        Business Class</option>
                                                    <option value="Premium Economy"
                                                        {{ $flightTicket->flight_class == 'Premium Economy' ? 'selected' : '' }}>
                                                        Premium Economy</option>
                                                    <option value="Economy Class"
                                                        {{ $flightTicket->flight_class == 'Economy Class' ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="f-14 text-dark-grey">Locator</label>
                                                <input type="text" class="form-control height-35 f-14"
                                                    name="locator[]" value="{{ $flightTicket->locator }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label class="f-14 text-dark-grey">Ticket Number</label>
                                                <input type="text" class="form-control height-35 f-14"
                                                    name="ticket_number[]"
                                                    value="{{ $flightTicket->ticket_number }}">
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-group">
                                                <label class="f-14 text-dark-grey">Notes</label>
                                                <textarea class="form-control" name="note_1[]" rows="2">{{ $flightTicket->note_1 }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                        @else
                            <!-- If there are no existing flight tickets, show one empty form -->
                            <div class="container-fluid">
                                <div id="flightItemsContainer">
                                    <!-- Initial Item -->
                                    <div class="flight-item card">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="f-14 text-dark-grey" data-label="true"
                                                        for="flight_no">Flight
                                                        Number
                                                        <sup class="f-14 mr-1">*</sup>
                                                    </label>
                                                    <input type="text" class="form-control height-35 f-14"
                                                        value="" name="flight_no[]" autocomplete="off"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control height-35 f-14"
                                                        value="" name="departure_date[]" autocomplete="off"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" class="form-control height-35 f-14"
                                                        value="" name="departure_time[]" autocomplete="off"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control height-35 f-14"
                                                        value="" name="arrival_date[]" autocomplete="off"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" class="form-control height-35 f-14"
                                                        value="" name="arrival_time[]" autocomplete="off"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-2 flight_from">
                                                <x-forms.select2-ajax fieldId="flight_from" fieldName="flight_from[]"
                                                    class="mb-0 mt-0" route="{{ route('guests.airports') }}"
                                                    fieldLabel="From" search="true">
                                                </x-forms.select2-ajax>
                                            </div>
                                            <div class="col-md-2 flight_to">
                                                <x-forms.select2-ajax fieldId="flight_to" fieldName="flight_to[]"
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control height-35 f-14"
                                                        value="" name="locator[]" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control height-35 f-14"
                                                        value="" name="ticket_number[]" autocomplete="off">
                                                </div>
                                            </div>
                ...
                <div class="container-fluid mt-4">
                    <div id="hotelItemsContainer">
                        @if ($dwcguest->hotelReservations->count() > 0)
                            @foreach ($dwcguest->hotelReservations as $index => $hotelReservation)
                                <div class="hotel-item card">
                                    <div class="hotel-header mb-3">
                                        <h5>Hotel Reservation</h5>
                                        {{-- <h5>Hotel Reservation #{{ $index + 1 }}</h5>
                                        <span class="remove-hotel"><i class="fas fa-times-circle"></i></span> --}}
                                    </div>
                                    <div class="row g-3">
                                        {{-- <div class="col-md-3 hotel_id">
                                            <x-forms.select2-ajax fieldId="hotel_id_{{ $index }}"
                                                fieldName="hotel_id[]" fieldClass="hotel-select"
                                                fieldLabel="Select Hotel" route="{{ route('guests.hotels') }}"
                                                search="true" selected="{{ $hotelReservation->hotel_id }}">
                                            </x-forms.select2-ajax>
                                        </div> --}}
                                        <div class="col-lg-2 col-md-2 hotel_id">
                                            <x-forms.label class="my-3" fieldId="hotel_id"
                                                :fieldLabel="__('app.Hotel')" fieldRequired="true">
                                            </x-forms.label>
                                            <x-forms.input-group>
                                                <select class="form-control select-picker" name="hotel_id[]" id="hotel_id" data-live-search="true">
                                                    <option value="">--</option>
                                                    @foreach ($selectedHotels as $hotel)
                                                        <option value="{{ $hotel->id }}"
                                                            {{ $hotelReservation->hotel_id == $hotel->id ? 'selected' : '' }}>
                                                            {{ $hotel->name }}
                                                        </option>
                                                    @endforeach
                                                    <option value="other" {{ $hotelReservation->hotel_id == '0' ? 'selected' : '' }}>Other</option>
                                                </select>
                                            </x-forms.input-group>
                                        </div>

                                        <!-- Hotel Name Field (Initially Hidden, but shown if "Other" is selected) -->
                                        <div class="col-md-2" id="hotel_name_field" style="{{ $hotelReservation->hotel_id == '0' ? '' : 'display: none;' }}">
                                            <div class="form-group">
                                                <label class="f-14 text-dark-grey" data-label="true">
                                                    Hotel Name
                                                    <sup class="f-14 mr-1">*</sup>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control height-35 f-14"
                                                    value="{{ $hotelReservation->room_type ?? '' }}"
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control height-35 f-14 check-in"
                                                    id="check_in_1" value="{{ $hotelReservation->checkin_date ?? '' }}" name="checkin_date[]"
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                    class="form-control height-35 f-14 check-out" id="check_out_1"
                                                    value="{{ $hotelReservation->checkout_date ?? '' }}" name="checkout_date[]" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control height-35 f-14 nights"
                                                    id="nights_1" value="{{ $hotelReservation->no_of_nights ?? 1 }}" name="no_of_nights[]"
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-md-2 hotel_id">
                                            <x-forms.label class="my-3" fieldId="billing_code"
                                                :fieldLabel="__('app.billingCode')" fieldRequired="true">
                                            </x-forms.label>
                                            <x-forms.input-group>
                                                <select class="form-control select-picker" name="billing_code[]"
                                                    ...
                                                    <option value="{{ $billingcode->id }}"
                                                        {{ $hotelReservation->billing_code == $billingcode->id ? 'selected' : '' }}>{{ $billingcode->name }}
                                                    </option>
                                                @endforeach
                                                </select>
                                            </x-forms.input-group>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                value="{{ $hotelReservation->confirmation_no ?? 1 }}" name="confirmation_no[]" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control height-35 f-14"
                                                    value="{{ $hotelReservation->sharing_with ?? '' }}"
                                        ...
                                        {{-- <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control height-35 f-14"
                                                    value="{{ $hotelReservation->category ?? '' }}" name="category[]"
                                                    autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control height-35 f-14"
                                                    value="{{ $hotelReservation->sub_category ?? '' }}"
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control height-35 f-14" name="note_2[]" rows="2">{{ $hotelReservation->note_2 ?? '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="hotelItemsContainer">
                                    ...
                                    <div class="hotel-item card">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-3 col-md-3 hotel_id">
                                                <x-forms.label class="my-3" fieldId="hotel_id"
                                                    :fieldLabel="__('app.Hotel')" fieldRequired="true">
                                                </x-forms.label>
                                                <x-forms.input-group>
                                                    <select class="form-control select-picker" name="hotel_id[]"
                                                        id="hotel_id" data-live-search="true">
                                                        <option value="">--</option>
                                                        @foreach ($selectedHotels as $hotel)
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control height-35 f-14"
                                                        value="" name="room_type[]" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control height-35 f-14 check-in"
                                                        id="check_in_1" value="" name="checkin_date[]"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date"
                                                        class="form-control height-35 f-14 check-out" id="check_out_1"
                                                        value="" name="checkout_date[]" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control height-35 f-14 nights"
                                                        id="nights_1" value="1" name="no_of_nights[]"
                                                        autocomplete="off">
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-3">
                                        ...
                                        <div class="col-lg-2 col-md-2 hotel_id">
                                            ...
                                            <x-forms.input-group>
                                                <select class="form-control select-picker" name="billing_code[]"
                                                    ...
                                                    <option value="">--</option>
                                                    @foreach ($billingcodes as $billingcode)
                                                        <option value="{{ $billingcode->id }}">{{ $billingcode->name }}</option>
                                                    @endforeach
                                                </select>
                                            </x-forms.input-group>
                                        </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control height-35 f-14"
                                                        value="1" name="confirmation_no[]" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control height-35 f-14"
                                                        value="" name="sharing_with[]" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                        ...
                        @endif
                        {{-- <button type="button" id="addHotel" class="btn btn-success mt-2 mb-2">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#save-more-guest-form').click(function() {
            ...
            const url = "{{ route('guests.update', $dwcguest->id) }}";
