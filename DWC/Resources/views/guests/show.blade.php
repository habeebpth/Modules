    ...
    <div class="d-flex d-lg-block filter-box project-header bg-white">
        ...
        <div class="project-menu" id="mob-client-detail">
            ...
            <nav class="tabs">
                <ul class="-primary">
                    <li>
                        <x-tab :href="route('guests.show', $guests->id)" :text="__('modules.projects.overview')" class="overview" />
                    </li>
                        <li>
                            <x-tab :href="route('guests.show', $guests->id).'?tab=tickets'" :text="__('app.tickets')"
                            class="tickets" />
                        </li>
                        <li>
                            <x-tab :href="route('guests.show', $guests->id).'?tab=hotelreservetion'" :text="__('app.hotelreservetion')"
                            class="hotelreservetion" />
                        </li>
                </ul>
            </nav>
        </div>
