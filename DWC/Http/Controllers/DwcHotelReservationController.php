...
use Modules\DWC\DataTables\DwcHotelReservationDataTable;
...
class DwcHotelReservationController extends AccountBaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->pageTitle = 'app.HotelReservations';
    ...
    public function index(DwcHotelReservationDataTable $dataTable)
    {
        if (!request()->ajax()) {
            $this->hotelreservation = DwcHotelReservation::all();
            // $this->skills = Skill::all();
        }

        // dd($this->data);

        return $dataTable->render('dwc::hotel-reservation.index', $this->data);
    }
