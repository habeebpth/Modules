...
use Modules\DWC\DataTables\DwcArrivalDataTable;
use Modules\DWC\DataTables\DwcDepartureDataTable;
...
class DwcReportController extends AccountBaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->pageTitle = 'app.Report';
    ...
    public function arrivalIndex(DwcArrivalDataTable $dataTable)
    {
        $this->pageTitle = 'app.Arrivals';
        $this->DwcAirport = DwcAirport::all();
        if (!request()->ajax()) {
            $this->DwcFlightTicket = DwcFlightTicket::all();
            // $this->skills = Skill::all();
        }

        // dd($this->data);

        return $dataTable->render('dwc::arrival.index', $this->data);
    }
    public function departureIndex(DwcDepartureDataTable $dataTable)
    {
        $this->pageTitle = 'app.Departures';
        $this->DwcAirport = DwcAirport::all();
        if (!request()->ajax()) {
            $this->DwcFlightTicket = DwcFlightTicket::all();
            // $this->skills = Skill::all();
        ...
        return $dataTable->render('dwc::departure.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('dwc::arrival.create', $this->data);
    }
    ...
    public function show($id)
    {
        ...
        switch ($tab) {
            ...
            case 'roomtype':
                $this->view = 'dwc::horse.ajax.roomtype';
                break;
            default:
