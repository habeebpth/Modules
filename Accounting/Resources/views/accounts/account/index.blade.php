    ...
    <div class="content-wrapper">
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                    <x-forms.link-primary :link="route('accounts.create')" class="mr-3 openRightModal float-left" icon="plus">
                        @lang('app.addAccount')
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group" aria-label="Basic example">
                <a href="{{ route('accounts.index') }}" class="btn btn-secondary f-14 btn-active"
                   data-toggle="tooltip"
                   data-original-title="@lang('modules.leaves.tableView')"><i class="side-icon bi bi-list-ul"></i></a>

                <a href="{{ route('accounts.hierarchy') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
...
<script>
    // $('#accounts-table').on('preXhr.dt', function(e, settings, data) {
    ...
    const showTable = () => {
        window.LaravelDataTables["accounts-table"].draw(true);
    }
