                            ...
                            <table class="table table-bordered" id="journal-entries-table">
                                ...
                                <tbody id="journal-entries-body">
                                    <tr class="journal-entry-row">
                                        ...
                                        <td>
                                            <input type="text" name="entries[0][description]" class="form-control entry-description" />
                                        </td>
                                        <td>
                                            <input type="number" name="entries[0][debit]" class="form-control debit-input" step="0.01" min="0" />
                                        </td>
                                        <td>
                                            <input type="number" name="entries[0][credit]" class="form-control credit-input" step="0.01" min="0" />
                                        </td>
                                        <td>
                                    ...
                                    <tr class="journal-entry-row">
                                        ...
                                        <td>
                                            <input type="text" name="entries[1][description]" class="form-control entry-description" />
                                        </td>
                                        <td>
                                            <input type="number" name="entries[1][debit]" class="form-control debit-input" step="0.01" min="0" />
                                        </td>
                                        <td>
                                            <input type="number" name="entries[1][credit]" class="form-control credit-input" step="0.01" min="0" />
                                        </td>
                                        <td>
    ...
    $('#add-entry').click(function() {
        const newRow = `
            <tr class="journal-entry-row">
                ...
                <td>
                    <input type="text" name="entries[${entryIndex}][description]" class="form-control entry-description" />
                </td>
                <td>
                    <input type="number" name="entries[${entryIndex}][debit]" class="form-control debit-input" step="0.01" min="0" />
                </td>
                <td>
                    <input type="number" name="entries[${entryIndex}][credit]" class="form-control credit-input" step="0.01" min="0" />
                </td>
                <td>
                    <button type="button" class="btn btn-sm btn-danger remove-entry">
                        <i class="fa fa-trash"></i>
