<x-form id="addaccounttypes" method="POST" class="ajax-form">
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading">@lang('accounting::app.Accounting.addAccType')</h5>
...
<script>
    ...
    $('#save-acctype').click(function() {
        $.easyAjax({
            url: "{{ route('acc-types-settings.store') }}",
            container: '#addaccounttypes',
            type: "POST",
            blockUI: true,
            disableButton: true,
            buttonSelector: "#save-acctype",
            data: $('#addaccounttypes').serialize(),
