    ...
    <div class="content-wrapper">
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                <x-forms.link-primary :link="route('event-registration.create')" class="mr-3 openRightModal float-left" icon="plus">
...
<script>
    ...
    const showTable = () => {
        window.LaravelDataTables["event-registration-table"].draw(true);
    }
