...
use Modules\HotelManagement\Database\factories\HMBookingSourceFactory;
use Illuminate\Database\Eloquent\SoftDeletes;

class HMBookingSource extends Model
{
    use HasFactory;
    use SoftDeletes;
    public const FILE_PATH = 'hmbookingsource';

    protected $table = 'hm_booking_sources'; // Add this line
    ...
    protected static function newFactory(): HMBookingSourceFactory
    {
        //return HMBookingSourceFactory::new();
    }
