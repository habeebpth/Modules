    ...
    <div class="d-flex d-lg-block filter-box project-header bg-white">
        ...
        <div class="project-menu" id="mob-client-detail">
            ...
            <nav class="tabs">
                <ul class="-primary">
                    <li>
                        <x-tab :href="route('hm-rooms.show', $hmrooms->id)" :text="__('modules.projects.overview')" class="overview" />
                    </li>
                        <li>
                            <x-tab :href="route('hm-rooms.show', $hmrooms->id).'?tab=files'" :text="__('app.images')"
                            class="files" />
                        </li>
                </ul>
            </nav>
