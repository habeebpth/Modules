<x-form id="addservices" method="PUT" class="ajax-form">
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading">@lang('hotelmanagement::app.hotelManagement.editService')</h5>
        ...
        <div class="portlet-body">
               ...
               <div class="col-sm-12 col-md-6">
                    <x-forms.text fieldId="service_name" :fieldLabel="__('hotelmanagement::app.hotelManagement.serviceTypeName')"
                                  fieldName="service_name" :fieldValue="$service->service_name" fieldRequired="true" />
                </div>

                <!-- Base Price Field -->
               <div class="col-sm-12 col-md-6">
                    <x-forms.number fieldId="base_price" :fieldLabel="__('hotelmanagement::app.hotelManagement.basePrice')"
                                    fieldName="base_price" :fieldValue="$service->base_price" fieldRequired="true" step="0.01" />
                </div>
                 <!-- Description Field -->
                <div class="col-sm-12 col-md-6">
                    <x-forms.textarea fieldId="description" :fieldLabel="__('hotelmanagement::app.hotelManagement.description')"
                                      fieldName="description" :fieldValue="$service->description" />
                </div>
...
<script>
    ...
    $('#save-services').click(function() {
        $.easyAjax({
            url: "{{route('hm-services-settings.update', $service->id)}}",
