    ...
    <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
        ...
        <div class="d-flex justify-content-between action-bar">
            <div id="table-actions" class="align-items-center">
                    <x-forms.link-primary :link="route('hm-rooms.create').'?default_assign='.$property->id"
...
<script>
    $('#hm-rooms-table').on('preXhr.dt', function(e, settings, data) {

        var assignedTo = "{{ $property->id }}";
    ...
    const showTable = () => {
        window.LaravelDataTables["hm-rooms-table"].draw(false);
    }
    ...
    $('body').on('click', '.delete-table-row-hmrooms', function() {
        var id = $(this).data('id');
        Swal.fire({
            title: "@lang('messages.sweetAlertTitle')",
            text: "@lang('messages.recoverRecord')",
            ...
            if (result.isConfirmed) {
                var url = "{{ route('hm-rooms.destroy', ':id') }}";
    ...
    const applyQuickAction = () => {
        var rowdIds = $("#hm-rooms-table input:checkbox:checked").map(function() {
            return $(this).val();
        }).get();
    ...
    $('#hm-rooms-table').on('change', '.change-status', function() {
    ...
    $('#hm-rooms-table').on('click', '.start-timer', function() {
    ...
    $('#hm-rooms-table').on('click', '.stop-timer', function() {
    ...
    $('#hm-rooms-table').on('click', '.resume-timer', function() {
        var id = $(this).data('time-id');
    ...
    $('#hm-rooms-table').on('click', '.pause-timer', function() {
        var id = $(this).data('time-id');
